...
# print(format_input_ip("192.168.10.130"),
# format_subnet_mask("255.255.255.192"),
# format_classful_status("class A"),
# format_network_address("192.168.10.128"),
# format_broadcast_address("192.168.10.191"),
# format_num_hosts(62),
# format_cidr_mask(26))
